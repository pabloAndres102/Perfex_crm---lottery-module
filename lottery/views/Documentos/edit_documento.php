            ...
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <h4 class="no-margin">Editar Tipo de Documento</h4>
                        <?php echo form_open('lottery/Documentos/edit/' . $documento->id, ['id' => 'edit-documento-form']); ?>
                        <div>
                            <label for="nombre">Nombre</label>
                            <input type="text" id="nombre" name="nombre" value="<?php echo strtoupper($documento->nombre); ?>" required style="text-transform: uppercase;">
                        </div>
                        <div>
                            <label for="descripcion">Descripción</label>
                            <textarea id="descripcion" name="descripcion" required style="text-transform: uppercase;"><?php echo strtoupper($documento->descripcion); ?></textarea>
                        </div>
