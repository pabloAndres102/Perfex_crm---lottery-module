        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    ...
                    <form  action="<?php echo site_url('lottery/municipios/edit/' . $municipio->id); ?>" method="post" enctype="multipart/form-data">
                    <?php echo form_hidden($this->security->get_csrf_token_name(), $this->security->get_csrf_hash()); ?>
                            <div>
                                <label for="nombre">Nombre</label>
                                <input type="text" id="nombre" name="nombre" value="<?php echo $municipio->nombre; ?>" required>
                            </div>
                            <div>
                                <label for="descripcion">Descripción</label>
                                <textarea id="descripcion" name="descripcion" required><?php echo $municipio->descripcion; ?></textarea>
                            </div>
